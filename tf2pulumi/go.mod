...
require (
	...
	github.com/yandex-cloud/terraform-provider-yandex v0.81.0
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/kms v1.18.16 // indirect
	...
	github.com/pulumi/schema-tools v0.1.1 // indirect
