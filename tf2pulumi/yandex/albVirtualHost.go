...
type AlbVirtualHost struct {
	...
	Timeouts AlbVirtualHostTimeoutsOutput   `pulumi:"timeouts"`
}
...
type albVirtualHostState struct {
	...
	Timeouts *AlbVirtualHostTimeouts `pulumi:"timeouts"`
}
...
type AlbVirtualHostState struct {
	...
	Timeouts AlbVirtualHostTimeoutsPtrInput
}
...
type AlbVirtualHostArgs struct {
	...
	// http '/' match first makes all other routes unused. The structure is documented below.
	Routes   AlbVirtualHostRouteArrayInput
	Timeouts AlbVirtualHostTimeoutsInput
}
...
func (o AlbVirtualHostOutput) Timeouts() AlbVirtualHostTimeoutsOutput {
	return o.ApplyT(func(v *AlbVirtualHost) AlbVirtualHostTimeoutsOutput { return v.Timeouts }).(AlbVirtualHostTimeoutsOutput)
}
