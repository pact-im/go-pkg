...
type KmsSecretCiphertext struct {
	...
	Timeouts  KmsSecretCiphertextTimeoutsOutput `pulumi:"timeouts"`
}
...
type KmsSecretCiphertextArgs struct {
	...
	Timeouts  KmsSecretCiphertextTimeoutsInput
}
...
func (o KmsSecretCiphertextOutput) Timeouts() KmsSecretCiphertextTimeoutsOutput {
	return o.ApplyT(func(v *KmsSecretCiphertext) KmsSecretCiphertextTimeoutsOutput { return v.Timeouts }).(KmsSecretCiphertextTimeoutsOutput)
}
