...
// Size of the masks that are assigned to each node in the cluster.
func (o LookupKubernetesClusterResultOutput) NodeIpv4CidrMaskSize() pulumi.Float64Output {
	return o.ApplyT(func(v LookupKubernetesClusterResult) float64 { return v.NodeIpv4CidrMaskSize }).(pulumi.Float64Output)
}
