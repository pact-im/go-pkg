...
type DataprocCluster struct {
	...
	Timeouts         DataprocClusterTimeoutsOutput `pulumi:"timeouts"`
...
type DataprocClusterArgs struct {
	...
	Timeouts         DataprocClusterTimeoutsInput
	// Whether to enable UI Proxy feature.
	UiProxy pulumi.BoolPtrInput
	// ID of the availability zone to create cluster in. If it is not provided, the default provider zone is used.
	ZoneId pulumi.StringPtrInput
...
func (o DataprocClusterOutput) Timeouts() DataprocClusterTimeoutsOutput {
	return o.ApplyT(func(v *DataprocCluster) DataprocClusterTimeoutsOutput { return v.Timeouts }).(DataprocClusterTimeoutsOutput)
}
