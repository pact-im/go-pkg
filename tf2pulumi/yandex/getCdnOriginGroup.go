...
type LookupCdnOriginGroupOutputArgs struct {
	...
	// The ID of a specific origin group.
	OriginGroupId pulumi.Float64PtrInput `pulumi:"originGroupId"`
}
...
func (o LookupCdnOriginGroupResultOutput) OriginGroupId() pulumi.Float64Output {
	return o.ApplyT(func(v LookupCdnOriginGroupResult) float64 { return v.OriginGroupId }).(pulumi.Float64Output)
}
