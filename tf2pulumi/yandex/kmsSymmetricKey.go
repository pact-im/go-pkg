...
type KmsSymmetricKey struct {
	...
	Timeouts KmsSymmetricKeyTimeoutsOutput `pulumi:"timeouts"`
}
...
type KmsSymmetricKeyArgs struct {
	...
	// Interval between automatic rotations. To disable automatic rotation, omit this parameter.
	RotationPeriod pulumi.StringPtrInput
	Timeouts       KmsSymmetricKeyTimeoutsInput
}
...
func (o KmsSymmetricKeyOutput) Timeouts() KmsSymmetricKeyTimeoutsOutput {
	return o.ApplyT(func(v *KmsSymmetricKey) KmsSymmetricKeyTimeoutsOutput { return v.Timeouts }).(KmsSymmetricKeyTimeoutsOutput)
}
