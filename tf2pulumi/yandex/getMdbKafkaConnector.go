...
// The number of the connector's parallel working tasks. Default is the number of brokers
func (o LookupMdbKafkaConnectorResultOutput) TasksMax() pulumi.Float64Output {
	return o.ApplyT(func(v LookupMdbKafkaConnectorResult) float64 { return v.TasksMax }).(pulumi.Float64Output)
}
