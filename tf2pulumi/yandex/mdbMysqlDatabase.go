...
type MdbMysqlDatabase struct {
	...
	Timeouts MdbMysqlDatabaseTimeoutsOutput `pulumi:"timeouts"`
}
...
type mdbMysqlDatabaseState struct {
	...
	Timeouts *MdbMysqlDatabaseTimeouts `pulumi:"timeouts"`
}
...
type MdbMysqlDatabaseState struct {
	...
	Timeouts MdbMysqlDatabaseTimeoutsPtrInput
}
...
type MdbMysqlDatabaseArgs struct {
	...
	// The name of the database.
	Name     pulumi.StringPtrInput
	Timeouts MdbMysqlDatabaseTimeoutsInput
}
...
func (o MdbMysqlDatabaseOutput) Timeouts() MdbMysqlDatabaseTimeoutsOutput {
	return o.ApplyT(func(v *MdbMysqlDatabase) MdbMysqlDatabaseTimeoutsOutput { return v.Timeouts }).(MdbMysqlDatabaseTimeoutsOutput)
}
