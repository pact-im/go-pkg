...
type ComputeInstance struct {
	...
	PlacementPolicy ComputeInstancePlacementPolicyPtrOutput `pulumi:"placementPolicy"`
	...
	SchedulingPolicy ComputeInstanceSchedulingPolicyPtrOutput `pulumi:"schedulingPolicy"`
	...
	Timeouts ComputeInstanceTimeoutsOutput `pulumi:"timeouts"`
...
type ComputeInstanceArgs struct {
	...
	// ID of the service account authorized for this instance.
	ServiceAccountId pulumi.StringPtrInput
	Timeouts         ComputeInstanceTimeoutsInput
	// The availability zone where the virtual machine will be created. If it is not provided,
	// the default provider folder is used.
	Zone pulumi.StringPtrInput
}
...
// The placement policy configuration. The structure is documented below.
func (o ComputeInstanceOutput) PlacementPolicy() ComputeInstancePlacementPolicyPtrOutput {
	return o.ApplyT(func(v *ComputeInstance) ComputeInstancePlacementPolicyPtrOutput { return v.PlacementPolicy }).(ComputeInstancePlacementPolicyPtrOutput)
}
...
// Scheduling policy configuration. The structure is documented below.
func (o ComputeInstanceOutput) SchedulingPolicy() ComputeInstanceSchedulingPolicyPtrOutput {
	return o.ApplyT(func(v *ComputeInstance) ComputeInstanceSchedulingPolicyPtrOutput { return v.SchedulingPolicy }).(ComputeInstanceSchedulingPolicyPtrOutput)
}
...
func (o ComputeInstanceOutput) Timeouts() ComputeInstanceTimeoutsOutput {
	return o.ApplyT(func(v *ComputeInstance) ComputeInstanceTimeoutsOutput { return v.Timeouts }).(ComputeInstanceTimeoutsOutput)
}
