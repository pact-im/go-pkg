...
type VpcGateway struct {
	...
	SharedEgressGateway VpcGatewaySharedEgressGatewayOutput `pulumi:"sharedEgressGateway"`
	Timeouts            VpcGatewayTimeoutsOutput            `pulumi:"timeouts"`
}
...
type vpcGatewayState struct {
	...
	Timeouts            *VpcGatewayTimeouts            `pulumi:"timeouts"`
}
...
type VpcGatewayState struct {
	...
	Timeouts            VpcGatewayTimeoutsPtrInput
}
...
type VpcGatewayArgs struct {
	...
	// Name of the VPC Gateway. Provided by the client when the VPC Gateway is created.
	Name     pulumi.StringPtrInput
	Timeouts VpcGatewayTimeoutsInput
}
...
// Shared egress gateway configuration. Currently empty.
func (o VpcGatewayOutput) SharedEgressGateway() VpcGatewaySharedEgressGatewayOutput {
	return o.ApplyT(func(v *VpcGateway) VpcGatewaySharedEgressGatewayOutput { return v.SharedEgressGateway }).(VpcGatewaySharedEgressGatewayOutput)
}

func (o VpcGatewayOutput) Timeouts() VpcGatewayTimeoutsOutput {
	return o.ApplyT(func(v *VpcGateway) VpcGatewayTimeoutsOutput { return v.Timeouts }).(VpcGatewayTimeoutsOutput)
}
