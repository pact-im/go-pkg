...
type IotCoreDevice struct {
	...
	Timeouts   IotCoreDeviceTimeoutsOutput `pulumi:"timeouts"`
}
...
type iotCoreDeviceState struct {
	...
	Timeouts   *IotCoreDeviceTimeouts `pulumi:"timeouts"`
}
...
type IotCoreDeviceState struct {
	...
	Timeouts   IotCoreDeviceTimeoutsPtrInput
}
...
type IotCoreDeviceArgs struct {
	...
	Timeouts   IotCoreDeviceTimeoutsInput
}
...
func (o IotCoreDeviceOutput) Timeouts() IotCoreDeviceTimeoutsOutput {
	return o.ApplyT(func(v *IotCoreDevice) IotCoreDeviceTimeoutsOutput { return v.Timeouts }).(IotCoreDeviceTimeoutsOutput)
}
