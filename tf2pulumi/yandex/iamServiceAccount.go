...
type IamServiceAccount struct {
	...
	Timeouts IamServiceAccountTimeoutsOutput `pulumi:"timeouts"`
}
...
type IamServiceAccountArgs struct {
	...
	// Can be updated without creating a new resource.
	Name     pulumi.StringPtrInput
	Timeouts IamServiceAccountTimeoutsInput
}
...
func (o IamServiceAccountOutput) Timeouts() IamServiceAccountTimeoutsOutput {
	return o.ApplyT(func(v *IamServiceAccount) IamServiceAccountTimeoutsOutput { return v.Timeouts }).(IamServiceAccountTimeoutsOutput)
}
