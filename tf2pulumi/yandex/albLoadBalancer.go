...
type AlbLoadBalancer struct {
	...
	Timeouts AlbLoadBalancerTimeoutsOutput `pulumi:"timeouts"`
}
...
type albLoadBalancerState struct {
	...
	Timeouts *AlbLoadBalancerTimeouts `pulumi:"timeouts"`
}
...
type AlbLoadBalancerState struct {
	...
	Timeouts AlbLoadBalancerTimeoutsPtrInput
}
...
type AlbLoadBalancerArgs struct {
	...
	// A list of ID's of security groups attached to the Load Balancer.
	SecurityGroupIds pulumi.StringArrayInput
	Timeouts         AlbLoadBalancerTimeoutsInput
}
...
func (o AlbLoadBalancerOutput) Timeouts() AlbLoadBalancerTimeoutsOutput {
	return o.ApplyT(func(v *AlbLoadBalancer) AlbLoadBalancerTimeoutsOutput { return v.Timeouts }).(AlbLoadBalancerTimeoutsOutput)
}
