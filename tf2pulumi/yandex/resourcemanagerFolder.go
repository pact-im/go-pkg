...
type ResourcemanagerFolder struct {
	...
	Timeouts ResourcemanagerFolderTimeoutsOutput `pulumi:"timeouts"`
}
...
type ResourcemanagerFolderArgs struct {
	...
	// The name of the Folder.
	Name     pulumi.StringPtrInput
	Timeouts ResourcemanagerFolderTimeoutsInput
}
...
func (o ResourcemanagerFolderOutput) Timeouts() ResourcemanagerFolderTimeoutsOutput {
	return o.ApplyT(func(v *ResourcemanagerFolder) ResourcemanagerFolderTimeoutsOutput { return v.Timeouts }).(ResourcemanagerFolderTimeoutsOutput)
}
