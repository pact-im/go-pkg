...
type KubernetesCluster struct {
	...
	NetworkImplementation KubernetesClusterNetworkImplementationOutput `pulumi:"networkImplementation"`
	...
	NodeIpv4CidrMaskSize pulumi.Float64PtrOutput `pulumi:"nodeIpv4CidrMaskSize"`
	...
	Timeouts KubernetesClusterTimeoutsOutput `pulumi:"timeouts"`
}
...
type kubernetesClusterState struct {
	...
	// Size of the masks that are assigned to each node in the cluster. Effectively limits maximum number of pods for each node.
	NodeIpv4CidrMaskSize *float64 `pulumi:"nodeIpv4CidrMaskSize"`
	// Service account to be used by the worker nodes of the Kubernetes cluster
	// to access Container Registry or to push node logs and metrics.
	...
	Timeouts *KubernetesClusterTimeouts `pulumi:"timeouts"`
}
...
type KubernetesClusterState struct {
	...
	// Size of the masks that are assigned to each node in the cluster. Effectively limits maximum number of pods for each node.
	NodeIpv4CidrMaskSize pulumi.Float64PtrInput
	// Service account to be used by the worker nodes of the Kubernetes cluster
	// to access Container Registry or to push node logs and metrics.
	...
	Timeouts KubernetesClusterTimeoutsPtrInput
}
...
type KubernetesClusterArgs struct {
	...
	// Identical to serviceIpv4Range but for IPv6 protocol.
	ServiceIpv6Range pulumi.StringPtrInput
	Timeouts         KubernetesClusterTimeoutsInput
}
...
// (Optional) Network Implementation options. The structure is documented below.
func (o KubernetesClusterOutput) NetworkImplementation() KubernetesClusterNetworkImplementationOutput {
	return o.ApplyT(func(v *KubernetesCluster) KubernetesClusterNetworkImplementationOutput {
...
// Size of the masks that are assigned to each node in the cluster. Effectively limits maximum number of pods for each node.
func (o KubernetesClusterOutput) NodeIpv4CidrMaskSize() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *KubernetesCluster) pulumi.Float64PtrOutput { return v.NodeIpv4CidrMaskSize }).(pulumi.Float64PtrOutput)
}
...
func (o KubernetesClusterOutput) Timeouts() KubernetesClusterTimeoutsOutput {
	return o.ApplyT(func(v *KubernetesCluster) KubernetesClusterTimeoutsOutput { return v.Timeouts }).(KubernetesClusterTimeoutsOutput)
}
