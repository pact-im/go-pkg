...
type KubernetesNodeGroup struct {
	...
	DeployPolicy KubernetesNodeGroupDeployPolicyPtrOutput `pulumi:"deployPolicy"`
	...
	MaintenancePolicy KubernetesNodeGroupMaintenancePolicyPtrOutput `pulumi:"maintenancePolicy"`
	...
	Timeouts KubernetesNodeGroupTimeoutsOutput `pulumi:"timeouts"`
...
type kubernetesNodeGroupState struct {
	...
	Timeouts *KubernetesNodeGroupTimeouts `pulumi:"timeouts"`
	// Version of Kubernetes that will be used for Kubernetes node group.
...
type KubernetesNodeGroupState struct {
	...
	Timeouts KubernetesNodeGroupTimeoutsPtrInput
	// Version of Kubernetes that will be used for Kubernetes node group.
...
type KubernetesNodeGroupArgs struct {
	...
	Timeouts    KubernetesNodeGroupTimeoutsInput
	// Version of Kubernetes that will be used for Kubernetes node group.
	Version pulumi.StringPtrInput
}
...
// Deploy policy of the node group. The structure is documented below.
func (o KubernetesNodeGroupOutput) DeployPolicy() KubernetesNodeGroupDeployPolicyPtrOutput {
	return o.ApplyT(func(v *KubernetesNodeGroup) KubernetesNodeGroupDeployPolicyPtrOutput { return v.DeployPolicy }).(KubernetesNodeGroupDeployPolicyPtrOutput)
}
...
// Revision upgrades are performed only within the same minor version, e.g. 1.13.
// Minor version upgrades (e.g. 1.13->1.14) should be performed manually. The structure is documented below.
func (o KubernetesNodeGroupOutput) MaintenancePolicy() KubernetesNodeGroupMaintenancePolicyPtrOutput {
	return o.ApplyT(func(v *KubernetesNodeGroup) KubernetesNodeGroupMaintenancePolicyPtrOutput { return v.MaintenancePolicy }).(KubernetesNodeGroupMaintenancePolicyPtrOutput)
}
...
func (o KubernetesNodeGroupOutput) Timeouts() KubernetesNodeGroupTimeoutsOutput {
	return o.ApplyT(func(v *KubernetesNodeGroup) KubernetesNodeGroupTimeoutsOutput { return v.Timeouts }).(KubernetesNodeGroupTimeoutsOutput)
}
