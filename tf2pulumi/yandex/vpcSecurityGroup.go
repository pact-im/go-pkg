...
type VpcSecurityGroup struct {
	...
	Timeouts VpcSecurityGroupTimeoutsOutput `pulumi:"timeouts"`
}
...
type vpcSecurityGroupState struct {
	...
	Timeouts *VpcSecurityGroupTimeouts `pulumi:"timeouts"`
}
...
type VpcSecurityGroupState struct {
	...
	Timeouts VpcSecurityGroupTimeoutsPtrInput
}
...
type VpcSecurityGroupArgs struct {
	...
	Timeouts  VpcSecurityGroupTimeoutsInput
}
...
func (o VpcSecurityGroupOutput) Timeouts() VpcSecurityGroupTimeoutsOutput {
	return o.ApplyT(func(v *VpcSecurityGroup) VpcSecurityGroupTimeoutsOutput { return v.Timeouts }).(VpcSecurityGroupTimeoutsOutput)
}
