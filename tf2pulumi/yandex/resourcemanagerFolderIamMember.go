...
func (o ResourcemanagerFolderIamMemberOutput) SleepAfter() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *ResourcemanagerFolderIamMember) pulumi.Float64PtrOutput { return v.SleepAfter }).(pulumi.Float64PtrOutput)
}
