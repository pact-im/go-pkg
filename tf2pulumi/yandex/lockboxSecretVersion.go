...
type LockboxSecretVersion struct {
	...
	Timeouts LockboxSecretVersionTimeoutsOutput `pulumi:"timeouts"`
}
...
type lockboxSecretVersionState struct {
	...
	Timeouts *LockboxSecretVersionTimeouts `pulumi:"timeouts"`
}
...
type LockboxSecretVersionState struct {
	...
	Timeouts LockboxSecretVersionTimeoutsPtrInput
}
...
type LockboxSecretVersionArgs struct {
	...
	Timeouts LockboxSecretVersionTimeoutsInput
}
...
func (o LockboxSecretVersionOutput) Timeouts() LockboxSecretVersionTimeoutsOutput {
	return o.ApplyT(func(v *LockboxSecretVersion) LockboxSecretVersionTimeoutsOutput { return v.Timeouts }).(LockboxSecretVersionTimeoutsOutput)
}
