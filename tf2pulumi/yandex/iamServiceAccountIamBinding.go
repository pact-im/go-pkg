...
func (o IamServiceAccountIamBindingOutput) SleepAfter() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *IamServiceAccountIamBinding) pulumi.Float64PtrOutput { return v.SleepAfter }).(pulumi.Float64PtrOutput)
}
