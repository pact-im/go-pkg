...
// The block size of the disk in bytes.
func (o LookupComputeDiskResultOutput) BlockSize() pulumi.Float64Output {
	return o.ApplyT(func(v LookupComputeDiskResult) float64 { return v.BlockSize }).(pulumi.Float64Output)
}
