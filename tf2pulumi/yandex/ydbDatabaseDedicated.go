...
type YdbDatabaseDedicated struct {
	...
	Timeouts  YdbDatabaseDedicatedTimeoutsOutput `pulumi:"timeouts"`
...
type ydbDatabaseDedicatedState struct {
	...
	Timeouts  *YdbDatabaseDedicatedTimeouts `pulumi:"timeouts"`
	// Whether TLS is enabled for the Yandex Database cluster.
	// Useful for SDK configuration.
...
type YdbDatabaseDedicatedState struct {
	...
	Timeouts  YdbDatabaseDedicatedTimeoutsPtrInput
	// Whether TLS is enabled for the Yandex Database cluster.
	// Useful for SDK configuration.
...
type YdbDatabaseDedicatedArgs struct {
	...
	// List of subnet IDs to attach the Yandex Database cluster to.
	SubnetIds pulumi.StringArrayInput
	Timeouts  YdbDatabaseDedicatedTimeoutsInput
}
...
func (o YdbDatabaseDedicatedOutput) Timeouts() YdbDatabaseDedicatedTimeoutsOutput {
	return o.ApplyT(func(v *YdbDatabaseDedicated) YdbDatabaseDedicatedTimeoutsOutput { return v.Timeouts }).(YdbDatabaseDedicatedTimeoutsOutput)
}
