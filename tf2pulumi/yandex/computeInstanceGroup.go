...
type ComputeInstanceGroup struct {
	...
	MaxCheckingHealthDuration pulumi.Float64PtrOutput `pulumi:"maxCheckingHealthDuration"`
	...
	Timeouts ComputeInstanceGroupTimeoutsOutput `pulumi:"timeouts"`
...
type ComputeInstanceGroupState struct {
	...
	// Timeout for waiting for the VM to become healthy. If the timeout is exceeded, the VM will be turned off based on the deployment policy. Specified in seconds.
	MaxCheckingHealthDuration pulumi.Float64PtrInput
	// Name template of the instance.\
	// In order to be unique it must contain at least one of instance unique placeholders:
	// {instance.short_id}
	// {instance.index}
...
type ComputeInstanceGroupArgs struct {
	...
	Timeouts         ComputeInstanceGroupTimeoutsInput
	// A set of key/value  variables pairs to assign to the instance group.
	Variables pulumi.StringMapInput
}
...
// Timeout for waiting for the VM to become healthy. If the timeout is exceeded, the VM will be turned off based on the deployment policy. Specified in seconds.
func (o ComputeInstanceGroupOutput) MaxCheckingHealthDuration() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *ComputeInstanceGroup) pulumi.Float64PtrOutput { return v.MaxCheckingHealthDuration }).(pulumi.Float64PtrOutput)
}
...
func (o ComputeInstanceGroupOutput) Timeouts() ComputeInstanceGroupTimeoutsOutput {
	return o.ApplyT(func(v *ComputeInstanceGroup) ComputeInstanceGroupTimeoutsOutput { return v.Timeouts }).(ComputeInstanceGroupTimeoutsOutput)
}
