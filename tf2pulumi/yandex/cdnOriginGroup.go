...
type CdnOriginGroup struct {
	...
	Timeouts CdnOriginGroupTimeoutsOutput    `pulumi:"timeouts"`
...
type cdnOriginGroupState struct {
	...
	Timeouts *CdnOriginGroupTimeouts `pulumi:"timeouts"`
	// If the option is active (has true value), in case the origin responds with 4XX or 5XX codes, use the next origin from the list.
...
type CdnOriginGroupState struct {
	...
	Timeouts CdnOriginGroupTimeoutsPtrInput
	// If the option is active (has true value), in case the origin responds with 4XX or 5XX codes, use the next origin from the list.
...
type CdnOriginGroupArgs struct {
	...
	Name     pulumi.StringPtrInput
	Origins  CdnOriginGroupOriginArrayInput
	Timeouts CdnOriginGroupTimeoutsInput
	// If the option is active (has true value), in case the origin responds with 4XX or 5XX codes, use the next origin from the list.
	UseNext pulumi.BoolPtrInput
}
...
func (o CdnOriginGroupOutput) Timeouts() CdnOriginGroupTimeoutsOutput {
	return o.ApplyT(func(v *CdnOriginGroup) CdnOriginGroupTimeoutsOutput { return v.Timeouts }).(CdnOriginGroupTimeoutsOutput)
}
