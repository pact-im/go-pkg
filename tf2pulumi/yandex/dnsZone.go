...
type DnsZone struct {
	...
	Timeouts DnsZoneTimeoutsOutput `pulumi:"timeouts"`
...
func (o DnsZoneOutput) Timeouts() DnsZoneTimeoutsOutput {
	return o.ApplyT(func(v *DnsZone) DnsZoneTimeoutsOutput { return v.Timeouts }).(DnsZoneTimeoutsOutput)
}
