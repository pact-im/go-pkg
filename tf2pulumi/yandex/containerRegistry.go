...
type ContainerRegistry struct {
	...
	Timeouts ContainerRegistryTimeoutsOutput `pulumi:"timeouts"`
}
...
type ContainerRegistryArgs struct {
	...
	// A name of the registry.
	Name     pulumi.StringPtrInput
	Timeouts ContainerRegistryTimeoutsInput
}
...
func (o ContainerRegistryOutput) Timeouts() ContainerRegistryTimeoutsOutput {
	return o.ApplyT(func(v *ContainerRegistry) ContainerRegistryTimeoutsOutput { return v.Timeouts }).(ContainerRegistryTimeoutsOutput)
}
