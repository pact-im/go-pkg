...
func (o ResourcemanagerFolderIamBindingOutput) SleepAfter() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *ResourcemanagerFolderIamBinding) pulumi.Float64PtrOutput { return v.SleepAfter }).(pulumi.Float64PtrOutput)
}
