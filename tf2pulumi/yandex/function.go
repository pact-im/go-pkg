...
type Function struct {
	...
	ImageSize pulumi.Float64Output `pulumi:"imageSize"`
	...
	Timeouts FunctionTimeoutsOutput   `pulumi:"timeouts"`
...
type functionState struct {
	...
	Timeouts *FunctionTimeouts `pulumi:"timeouts"`
	// User-defined string for current function version. User must change this string any times when function changed. Function will be updated when hash is changed.
...
type FunctionState struct {
	...
	// Image size for Yandex Cloud Function.
	ImageSize pulumi.Float64PtrInput
	// A set of key/value label pairs to assign to the Yandex Cloud Function
	...
	Timeouts FunctionTimeoutsPtrInput
	// User-defined string for current function version. User must change this string any times when function changed. Function will be updated when hash is changed.
...
type FunctionArgs struct {
	...
	// Tags for Yandex Cloud Function. Tag "$latest" isn't returned.
	Tags     pulumi.StringArrayInput
	Timeouts FunctionTimeoutsInput
	// User-defined string for current function version. User must change this string any times when function changed. Function will be updated when hash is changed.
...
// Image size for Yandex Cloud Function.
func (o FunctionOutput) ImageSize() pulumi.Float64Output {
	return o.ApplyT(func(v *Function) pulumi.Float64Output { return v.ImageSize }).(pulumi.Float64Output)
}
...
// Memory in megabytes (**aligned to 128MB**) for Yandex Cloud Function
func (o FunctionOutput) Memory() pulumi.Float64Output {
	return o.ApplyT(func(v *Function) pulumi.Float64Output { return v.Memory }).(pulumi.Float64Output)
}
...
func (o FunctionOutput) Timeouts() FunctionTimeoutsOutput {
	return o.ApplyT(func(v *Function) FunctionTimeoutsOutput { return v.Timeouts }).(FunctionTimeoutsOutput)
}
