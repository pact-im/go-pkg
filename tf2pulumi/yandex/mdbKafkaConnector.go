...
type MdbKafkaConnector struct {
	...
	TasksMax                    pulumi.Float64PtrOutput                                `pulumi:"tasksMax"`
}
...
type mdbKafkaConnectorState struct {
	...
	TasksMax                    *float64                                      `pulumi:"tasksMax"`
}
...
type MdbKafkaConnectorState struct {
	...
	TasksMax                    pulumi.Float64PtrInput
}
...
func (o MdbKafkaConnectorOutput) TasksMax() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *MdbKafkaConnector) pulumi.Float64PtrOutput { return v.TasksMax }).(pulumi.Float64PtrOutput)
}
