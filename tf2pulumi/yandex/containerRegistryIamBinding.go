...
func (o ContainerRegistryIamBindingOutput) SleepAfter() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *ContainerRegistryIamBinding) pulumi.Float64PtrOutput { return v.SleepAfter }).(pulumi.Float64PtrOutput)
}
