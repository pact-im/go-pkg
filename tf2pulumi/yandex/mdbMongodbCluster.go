...
type MdbMongodbCluster struct {
	...
	MaintenanceWindow MdbMongodbClusterMaintenanceWindowPtrOutput `pulumi:"maintenanceWindow"`
	...
	Timeouts MdbMongodbClusterTimeoutsOutput `pulumi:"timeouts"`
...
type mdbMongodbClusterState struct {
	...
	Timeouts *MdbMongodbClusterTimeouts `pulumi:"timeouts"`
	// A user of the MongoDB cluster. The structure is documented below.
...
type MdbMongodbClusterState struct {
	...
	Timeouts MdbMongodbClusterTimeoutsPtrInput
	// A user of the MongoDB cluster. The structure is documented below.
...
type MdbMongodbClusterArgs struct {
	...
	// A set of ids of security groups assigned to hosts of the cluster.
	SecurityGroupIds pulumi.StringArrayInput
	Timeouts         MdbMongodbClusterTimeoutsInput
	// A user of the MongoDB cluster. The structure is documented below.
	Users MdbMongodbClusterUserArrayInput
}
...
func (o MdbMongodbClusterOutput) MaintenanceWindow() MdbMongodbClusterMaintenanceWindowPtrOutput {
	return o.ApplyT(func(v *MdbMongodbCluster) MdbMongodbClusterMaintenanceWindowPtrOutput { return v.MaintenanceWindow }).(MdbMongodbClusterMaintenanceWindowPtrOutput)
}
...
func (o MdbMongodbClusterOutput) Timeouts() MdbMongodbClusterTimeoutsOutput {
	return o.ApplyT(func(v *MdbMongodbCluster) MdbMongodbClusterTimeoutsOutput { return v.Timeouts }).(MdbMongodbClusterTimeoutsOutput)
}
