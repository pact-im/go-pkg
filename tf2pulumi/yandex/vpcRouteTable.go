...
type VpcRouteTable struct {
	...
	Timeouts     VpcRouteTableTimeoutsOutput         `pulumi:"timeouts"`
}
...
type vpcRouteTableState struct {
	...
	Timeouts     *VpcRouteTableTimeouts     `pulumi:"timeouts"`
}
...
type VpcRouteTableState struct {
	...
	Timeouts     VpcRouteTableTimeoutsPtrInput
}
...
type VpcRouteTableArgs struct {
	...
	// A list of static route records for the route table. The structure is documented below.
	StaticRoutes VpcRouteTableStaticRouteArrayInput
	Timeouts     VpcRouteTableTimeoutsInput
}
...
func (o VpcRouteTableOutput) Timeouts() VpcRouteTableTimeoutsOutput {
	return o.ApplyT(func(v *VpcRouteTable) VpcRouteTableTimeoutsOutput { return v.Timeouts }).(VpcRouteTableTimeoutsOutput)
}
