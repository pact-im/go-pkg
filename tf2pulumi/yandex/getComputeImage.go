...
// Minimum size of the disk which is created from this image.
func (o LookupComputeImageResultOutput) MinDiskSize() pulumi.Float64Output {
	return o.ApplyT(func(v LookupComputeImageResult) float64 { return v.MinDiskSize }).(pulumi.Float64Output)
}
...
// The size of the image, specified in Gb.
func (o LookupComputeImageResultOutput) Size() pulumi.Float64Output {
	return o.ApplyT(func(v LookupComputeImageResult) float64 { return v.Size }).(pulumi.Float64Output)
}
