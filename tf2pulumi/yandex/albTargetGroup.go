...
type AlbTargetGroup struct {
	...
	Timeouts AlbTargetGroupTimeoutsOutput    `pulumi:"timeouts"`
}
...
type albTargetGroupState struct {
	...
	Timeouts *AlbTargetGroupTimeouts `pulumi:"timeouts"`
}
...
type AlbTargetGroupState struct {
	...
	Timeouts AlbTargetGroupTimeoutsPtrInput
}
...
type AlbTargetGroupArgs struct {
	...
	// A Target resource. The structure is documented below.
	Targets  AlbTargetGroupTargetArrayInput
	Timeouts AlbTargetGroupTimeoutsInput
}
...
func (o AlbTargetGroupOutput) Timeouts() AlbTargetGroupTimeoutsOutput {
	return o.ApplyT(func(v *AlbTargetGroup) AlbTargetGroupTimeoutsOutput { return v.Timeouts }).(AlbTargetGroupTimeoutsOutput)
}
