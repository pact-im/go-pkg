...
type ComputeSnapshot struct {
	...
	StorageSize pulumi.Float64Output          `pulumi:"storageSize"`
	Timeouts    ComputeSnapshotTimeoutsOutput `pulumi:"timeouts"`
}
...
type ComputeSnapshotState struct {
	...
	// Size of the snapshot, specified in GB.
	StorageSize pulumi.Float64PtrInput
...
type ComputeSnapshotArgs struct {
	...
	Timeouts     ComputeSnapshotTimeoutsInput
}
...
// Size of the disk when the snapshot was created, specified in GB.
func (o ComputeSnapshotOutput) DiskSize() pulumi.Float64Output {
	return o.ApplyT(func(v *ComputeSnapshot) pulumi.Float64Output { return v.DiskSize }).(pulumi.Float64Output)
}
...
// Size of the snapshot, specified in GB.
func (o ComputeSnapshotOutput) StorageSize() pulumi.Float64Output {
	return o.ApplyT(func(v *ComputeSnapshot) pulumi.Float64Output { return v.StorageSize }).(pulumi.Float64Output)
}

func (o ComputeSnapshotOutput) Timeouts() ComputeSnapshotTimeoutsOutput {
	return o.ApplyT(func(v *ComputeSnapshot) ComputeSnapshotTimeoutsOutput { return v.Timeouts }).(ComputeSnapshotTimeoutsOutput)
}
