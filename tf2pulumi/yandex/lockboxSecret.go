...
type LockboxSecret struct {
	...
	Timeouts LockboxSecretTimeoutsOutput `pulumi:"timeouts"`
}
...
type lockboxSecretState struct {
	...
	Timeouts *LockboxSecretTimeouts `pulumi:"timeouts"`
}
...
type LockboxSecretState struct {
	...
	Timeouts LockboxSecretTimeoutsPtrInput
}
...
type LockboxSecretArgs struct {
	...
	// Name for the Yandex Cloud Lockbox secret.
	Name     pulumi.StringPtrInput
	Timeouts LockboxSecretTimeoutsInput
}
...
func (o LockboxSecretOutput) Timeouts() LockboxSecretTimeoutsOutput {
	return o.ApplyT(func(v *LockboxSecret) LockboxSecretTimeoutsOutput { return v.Timeouts }).(LockboxSecretTimeoutsOutput)
}
