...
type ContainerRepository struct {
	...
	Timeouts ContainerRepositoryTimeoutsOutput `pulumi:"timeouts"`
}
...
type ContainerRepositoryArgs struct {
	// A name of the repository. The name of the repository should start with id of a container registry and match the name of the images that will be pushed in the repository.
	Name     pulumi.StringPtrInput
	Timeouts ContainerRepositoryTimeoutsInput
}
...
func (o ContainerRepositoryOutput) Timeouts() ContainerRepositoryTimeoutsOutput {
	return o.ApplyT(func(v *ContainerRepository) ContainerRepositoryTimeoutsOutput { return v.Timeouts }).(ContainerRepositoryTimeoutsOutput)
}
