...
// The period in days during which backups are stored.
func (o LookupMdbMysqlClusterResultOutput) BackupRetainPeriodDays() pulumi.Float64Output {
	return o.ApplyT(func(v LookupMdbMysqlClusterResult) float64 { return v.BackupRetainPeriodDays }).(pulumi.Float64Output)
}
