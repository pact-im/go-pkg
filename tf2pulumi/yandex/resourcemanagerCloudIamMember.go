...
func (o ResourcemanagerCloudIamMemberOutput) SleepAfter() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *ResourcemanagerCloudIamMember) pulumi.Float64PtrOutput { return v.SleepAfter }).(pulumi.Float64PtrOutput)
}
