...
type ComputeDiskPlacementGroup struct {
	...
	Timeouts ComputeDiskPlacementGroupTimeoutsOutput `pulumi:"timeouts"`
...
type ComputeDiskPlacementGroupArgs struct {
	...
	// The name of the Disk Placement Group.
	Name     pulumi.StringPtrInput
	Timeouts ComputeDiskPlacementGroupTimeoutsInput
	// ID of the zone where the Disk Placement Group resides.
	Zone pulumi.StringPtrInput
}
...
func (o ComputeDiskPlacementGroupOutput) Timeouts() ComputeDiskPlacementGroupTimeoutsOutput {
	return o.ApplyT(func(v *ComputeDiskPlacementGroup) ComputeDiskPlacementGroupTimeoutsOutput { return v.Timeouts }).(ComputeDiskPlacementGroupTimeoutsOutput)
}
