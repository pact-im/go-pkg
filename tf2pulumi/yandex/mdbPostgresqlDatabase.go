...
type MdbPostgresqlDatabase struct {
	...
	Timeouts   MdbPostgresqlDatabaseTimeoutsOutput `pulumi:"timeouts"`
}
...
type mdbPostgresqlDatabaseState struct {
	...
	Timeouts   *MdbPostgresqlDatabaseTimeouts `pulumi:"timeouts"`
}
...
type MdbPostgresqlDatabaseState struct {
	...
	Timeouts   MdbPostgresqlDatabaseTimeoutsPtrInput
}
...
type MdbPostgresqlDatabaseArgs struct {
	...
	// Name of the template database.
	TemplateDb pulumi.StringPtrInput
	Timeouts   MdbPostgresqlDatabaseTimeoutsInput
}
...
func (o MdbPostgresqlDatabaseOutput) Timeouts() MdbPostgresqlDatabaseTimeoutsOutput {
	return o.ApplyT(func(v *MdbPostgresqlDatabase) MdbPostgresqlDatabaseTimeoutsOutput { return v.Timeouts }).(MdbPostgresqlDatabaseTimeoutsOutput)
}
