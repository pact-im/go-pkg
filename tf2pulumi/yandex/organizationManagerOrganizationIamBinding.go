...
func (o OrganizationManagerOrganizationIamBindingOutput) SleepAfter() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *OrganizationManagerOrganizationIamBinding) pulumi.Float64PtrOutput { return v.SleepAfter }).(pulumi.Float64PtrOutput)
}
