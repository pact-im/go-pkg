...
type DnsRecordSet struct {
	...
	Timeouts DnsRecordSetTimeoutsOutput `pulumi:"timeouts"`
...
type DnsRecordSetArgs struct {
	...
	// The DNS name this record set will apply to.
	Name     pulumi.StringPtrInput
	Timeouts DnsRecordSetTimeoutsInput
	// The time-to-live of this record set (seconds).
...
func (o DnsRecordSetOutput) Timeouts() DnsRecordSetTimeoutsOutput {
	return o.ApplyT(func(v *DnsRecordSet) DnsRecordSetTimeoutsOutput { return v.Timeouts }).(DnsRecordSetTimeoutsOutput)
}

// The time-to-live of this record set (seconds).
func (o DnsRecordSetOutput) Ttl() pulumi.Float64Output {
	return o.ApplyT(func(v *DnsRecordSet) pulumi.Float64Output { return v.Ttl }).(pulumi.Float64Output)
}
