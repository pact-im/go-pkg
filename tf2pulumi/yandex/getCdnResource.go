...
func (o LookupCdnResourceResultOutput) OriginGroupId() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v LookupCdnResourceResult) *float64 { return v.OriginGroupId }).(pulumi.Float64PtrOutput)
}
