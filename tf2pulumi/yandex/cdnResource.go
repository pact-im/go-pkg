...
type CdnResource struct {
	...
	OriginGroupId   pulumi.Float64PtrOutput  `pulumi:"originGroupId"`
	...
	Timeouts       CdnResourceTimeoutsOutput          `pulumi:"timeouts"`
...
type cdnResourceState struct {
	...
	OriginGroupId   *float64            `pulumi:"originGroupId"`
	...
	Timeouts       *CdnResourceTimeouts       `pulumi:"timeouts"`
...
type CdnResourceState struct {
	...
	OriginGroupId   pulumi.Float64PtrInput
	...
	Timeouts       CdnResourceTimeoutsPtrInput
...
type CdnResourceArgs struct {
	...
	// ---
	SslCertificate CdnResourceSslCertificatePtrInput
	Timeouts       CdnResourceTimeoutsInput
	UpdatedAt      pulumi.StringPtrInput
}
...
func (o CdnResourceOutput) OriginGroupId() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *CdnResource) pulumi.Float64PtrOutput { return v.OriginGroupId }).(pulumi.Float64PtrOutput)
}
...
// SSL certificate of CDN resource.
// ---
func (o CdnResourceOutput) SslCertificate() CdnResourceSslCertificatePtrOutput {
	return o.ApplyT(func(v *CdnResource) CdnResourceSslCertificatePtrOutput { return v.SslCertificate }).(CdnResourceSslCertificatePtrOutput)
}

func (o CdnResourceOutput) Timeouts() CdnResourceTimeoutsOutput {
	return o.ApplyT(func(v *CdnResource) CdnResourceTimeoutsOutput { return v.Timeouts }).(CdnResourceTimeoutsOutput)
}
