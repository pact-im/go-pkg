...
type AlbHttpRouter struct {
	...
	Timeouts     AlbHttpRouterTimeoutsOutput        `pulumi:"timeouts"`
}
...
type albHttpRouterState struct {
	...
	Timeouts     *AlbHttpRouterTimeouts     `pulumi:"timeouts"`
}
...
type AlbHttpRouterState struct {
	...
	Timeouts     AlbHttpRouterTimeoutsPtrInput
}
...
type AlbHttpRouterArgs struct {
	...
	Name         pulumi.StringPtrInput
	RouteOptions AlbHttpRouterRouteOptionsPtrInput
	Timeouts     AlbHttpRouterTimeoutsInput
}
...
func (o AlbHttpRouterOutput) Timeouts() AlbHttpRouterTimeoutsOutput {
	return o.ApplyT(func(v *AlbHttpRouter) AlbHttpRouterTimeoutsOutput { return v.Timeouts }).(AlbHttpRouterTimeoutsOutput)
}
