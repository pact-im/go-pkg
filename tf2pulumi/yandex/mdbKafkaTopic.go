...
type MdbKafkaTopic struct {
	...
	Timeouts          MdbKafkaTopicTimeoutsOutput `pulumi:"timeouts"`
...
type mdbKafkaTopicState struct {
	...
	Timeouts          *MdbKafkaTopicTimeouts `pulumi:"timeouts"`
	// User-defined settings for the topic. The structure is documented below.
...
type MdbKafkaTopicState struct {
	...
	Timeouts          MdbKafkaTopicTimeoutsPtrInput
	// User-defined settings for the topic. The structure is documented below.
...
type MdbKafkaTopicArgs struct {
	...
	Name pulumi.StringPtrInput
	// The number of the topic's partitions.
	Partitions pulumi.Float64Input
	// Amount of data copies (replicas) for the topic in the cluster.
	ReplicationFactor pulumi.Float64Input
	Timeouts          MdbKafkaTopicTimeoutsInput
	// User-defined settings for the topic. The structure is documented below.
	TopicConfig MdbKafkaTopicTopicConfigPtrInput
}
...
// The number of the topic's partitions.
func (o MdbKafkaTopicOutput) Partitions() pulumi.Float64Output {
	return o.ApplyT(func(v *MdbKafkaTopic) pulumi.Float64Output { return v.Partitions }).(pulumi.Float64Output)
}

// Amount of data copies (replicas) for the topic in the cluster.
func (o MdbKafkaTopicOutput) ReplicationFactor() pulumi.Float64Output {
	return o.ApplyT(func(v *MdbKafkaTopic) pulumi.Float64Output { return v.ReplicationFactor }).(pulumi.Float64Output)
}

func (o MdbKafkaTopicOutput) Timeouts() MdbKafkaTopicTimeoutsOutput {
	return o.ApplyT(func(v *MdbKafkaTopic) MdbKafkaTopicTimeoutsOutput { return v.Timeouts }).(MdbKafkaTopicTimeoutsOutput)
}
