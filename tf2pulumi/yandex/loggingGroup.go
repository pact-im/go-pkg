...
type LoggingGroup struct {
	...
	Timeouts LoggingGroupTimeoutsOutput `pulumi:"timeouts"`
}
...
type LoggingGroupArgs struct {
	...
	// Log entries retention period for the Yandex Cloud Logging group.
	RetentionPeriod pulumi.StringPtrInput
	Timeouts        LoggingGroupTimeoutsInput
}
...
func (o LoggingGroupOutput) Timeouts() LoggingGroupTimeoutsOutput {
	return o.ApplyT(func(v *LoggingGroup) LoggingGroupTimeoutsOutput { return v.Timeouts }).(LoggingGroupTimeoutsOutput)
}
