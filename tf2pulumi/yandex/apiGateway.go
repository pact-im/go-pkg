...
type ApiGateway struct {
	...
	Timeouts ApiGatewayTimeoutsOutput `pulumi:"timeouts"`
...
type apiGatewayState struct {
	...
	Timeouts *ApiGatewayTimeouts `pulumi:"timeouts"`
	// Set of user domains attached to Yandex API Gateway.
...
type ApiGatewayState struct {
	...
	Timeouts ApiGatewayTimeoutsPtrInput
	// Set of user domains attached to Yandex API Gateway.
...
type ApiGatewayArgs struct {
	...
	Timeouts ApiGatewayTimeoutsInput
}
...
func (o ApiGatewayOutput) Timeouts() ApiGatewayTimeoutsOutput {
	return o.ApplyT(func(v *ApiGateway) ApiGatewayTimeoutsOutput { return v.Timeouts }).(ApiGatewayTimeoutsOutput)
}
