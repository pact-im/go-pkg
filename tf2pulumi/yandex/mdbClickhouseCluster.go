...
type MdbClickhouseCluster struct {
	...
	Access MdbClickhouseClusterAccessPtrOutput `pulumi:"access"`
	...
	BackupWindowStart MdbClickhouseClusterBackupWindowStartPtrOutput `pulumi:"backupWindowStart"`
	...
	MaintenanceWindow MdbClickhouseClusterMaintenanceWindowPtrOutput `pulumi:"maintenanceWindow"`
	...
	Timeouts MdbClickhouseClusterTimeoutsOutput `pulumi:"timeouts"`
...
type mdbClickhouseClusterState struct {
	...
	Timeouts *MdbClickhouseClusterTimeouts `pulumi:"timeouts"`
	// A user of the ClickHouse cluster. The structure is documented below.
...
type MdbClickhouseClusterState struct {
	...
	Timeouts MdbClickhouseClusterTimeoutsPtrInput
	// A user of the ClickHouse cluster. The structure is documented below.
...
type MdbClickhouseClusterArgs struct {
	...
	// Enables `admin` user with user management permission.
	SqlUserManagement pulumi.BoolPtrInput
	Timeouts          MdbClickhouseClusterTimeoutsInput
	// A user of the ClickHouse cluster. The structure is documented below.
	Users MdbClickhouseClusterUserArrayInput
	// Version of the ClickHouse server software.
	Version pulumi.StringPtrInput
...
// Access policy to the ClickHouse cluster. The structure is documented below.
func (o MdbClickhouseClusterOutput) Access() MdbClickhouseClusterAccessPtrOutput {
	return o.ApplyT(func(v *MdbClickhouseCluster) MdbClickhouseClusterAccessPtrOutput { return v.Access }).(MdbClickhouseClusterAccessPtrOutput)
}
...
// Time to start the daily backup, in the UTC timezone. The structure is documented below.
func (o MdbClickhouseClusterOutput) BackupWindowStart() MdbClickhouseClusterBackupWindowStartPtrOutput {
	return o.ApplyT(func(v *MdbClickhouseCluster) MdbClickhouseClusterBackupWindowStartPtrOutput {
...
func (o MdbClickhouseClusterOutput) MaintenanceWindow() MdbClickhouseClusterMaintenanceWindowPtrOutput {
	return o.ApplyT(func(v *MdbClickhouseCluster) MdbClickhouseClusterMaintenanceWindowPtrOutput {
...
func (o MdbClickhouseClusterOutput) Timeouts() MdbClickhouseClusterTimeoutsOutput {
	return o.ApplyT(func(v *MdbClickhouseCluster) MdbClickhouseClusterTimeoutsOutput { return v.Timeouts }).(MdbClickhouseClusterTimeoutsOutput)
}
