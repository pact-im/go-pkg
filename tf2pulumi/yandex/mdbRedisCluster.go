...
type MdbRedisCluster struct {
	...
	MaintenanceWindow MdbRedisClusterMaintenanceWindowPtrOutput `pulumi:"maintenanceWindow"`
	...
	Timeouts MdbRedisClusterTimeoutsOutput `pulumi:"timeouts"`
...
type mdbRedisClusterState struct {
	...
	Timeouts *MdbRedisClusterTimeouts `pulumi:"timeouts"`
	// TLS support mode enabled/disabled.
...
type MdbRedisClusterState struct {
	...
	Timeouts MdbRedisClusterTimeoutsPtrInput
	// TLS support mode enabled/disabled.
...
type MdbRedisClusterArgs struct {
	...
	// Redis Cluster mode enabled/disabled.
	Sharded  pulumi.BoolPtrInput
	Timeouts MdbRedisClusterTimeoutsInput
	// TLS support mode enabled/disabled.
	TlsEnabled pulumi.BoolPtrInput
}
...
func (o MdbRedisClusterOutput) MaintenanceWindow() MdbRedisClusterMaintenanceWindowPtrOutput {
	return o.ApplyT(func(v *MdbRedisCluster) MdbRedisClusterMaintenanceWindowPtrOutput { return v.MaintenanceWindow }).(MdbRedisClusterMaintenanceWindowPtrOutput)
}
...
func (o MdbRedisClusterOutput) Timeouts() MdbRedisClusterTimeoutsOutput {
	return o.ApplyT(func(v *MdbRedisCluster) MdbRedisClusterTimeoutsOutput { return v.Timeouts }).(MdbRedisClusterTimeoutsOutput)
}
