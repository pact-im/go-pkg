...
func (o OrganizationManagerOrganizationIamMemberOutput) SleepAfter() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *OrganizationManagerOrganizationIamMember) pulumi.Float64PtrOutput { return v.SleepAfter }).(pulumi.Float64PtrOutput)
}
