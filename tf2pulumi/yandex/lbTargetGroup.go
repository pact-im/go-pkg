...
type LbTargetGroup struct {
	...
	Timeouts LbTargetGroupTimeoutsOutput    `pulumi:"timeouts"`
}
...
type LbTargetGroupArgs struct {
	...
	// A Target resource. The structure is documented below.
	Targets  LbTargetGroupTargetArrayInput
	Timeouts LbTargetGroupTimeoutsInput
}
...
func (o LbTargetGroupOutput) Timeouts() LbTargetGroupTimeoutsOutput {
	return o.ApplyT(func(v *LbTargetGroup) LbTargetGroupTimeoutsOutput { return v.Timeouts }).(LbTargetGroupTimeoutsOutput)
}
