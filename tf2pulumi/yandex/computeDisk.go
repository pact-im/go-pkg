...
type ComputeDisk struct {
	...
	BlockSize pulumi.Float64PtrOutput `pulumi:"blockSize"`
	...
	DiskPlacementPolicy ComputeDiskDiskPlacementPolicyPtrOutput `pulumi:"diskPlacementPolicy"`
	...
	Timeouts ComputeDiskTimeoutsOutput `pulumi:"timeouts"`
...
type computeDiskState struct {
	...
	// Block size of the disk, specified in bytes.
	BlockSize *float64 `pulumi:"blockSize"`
	// Creation timestamp of the disk.
...
type ComputeDiskState struct {
	...
	// Block size of the disk, specified in bytes.
	BlockSize pulumi.Float64PtrInput
	// Creation timestamp of the disk.
...
type ComputeDiskArgs struct {
	...
	// The source snapshot to use for disk creation.
	SnapshotId pulumi.StringPtrInput
	Timeouts   ComputeDiskTimeoutsInput
	// Type of disk to create. Provide this when creating a disk.
	Type pulumi.StringPtrInput
	// Availability zone where the disk will reside.
	Zone pulumi.StringPtrInput
...
// Block size of the disk, specified in bytes.
func (o ComputeDiskOutput) BlockSize() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *ComputeDisk) pulumi.Float64PtrOutput { return v.BlockSize }).(pulumi.Float64PtrOutput)
}
...
// Disk placement policy configuration. The structure is documented below.
func (o ComputeDiskOutput) DiskPlacementPolicy() ComputeDiskDiskPlacementPolicyPtrOutput {
	return o.ApplyT(func(v *ComputeDisk) ComputeDiskDiskPlacementPolicyPtrOutput { return v.DiskPlacementPolicy }).(ComputeDiskDiskPlacementPolicyPtrOutput)
}
...
// the size value must not be less than the size of the source image
// or the size of the snapshot.
func (o ComputeDiskOutput) Size() pulumi.Float64PtrOutput {
	return o.ApplyT(func(v *ComputeDisk) pulumi.Float64PtrOutput { return v.Size }).(pulumi.Float64PtrOutput)
}
...
func (o ComputeDiskOutput) Timeouts() ComputeDiskTimeoutsOutput {
	return o.ApplyT(func(v *ComputeDisk) ComputeDiskTimeoutsOutput { return v.Timeouts }).(ComputeDiskTimeoutsOutput)
}
