...
type LookupDnsZoneOutputArgs struct {
	...
	Timeouts GetDnsZoneTimeoutsInput `pulumi:"timeouts"`
}
...
func (o LookupDnsZoneResultOutput) Timeouts() GetDnsZoneTimeoutsOutput {
	return o.ApplyT(func(v LookupDnsZoneResult) GetDnsZoneTimeouts { return v.Timeouts }).(GetDnsZoneTimeoutsOutput)
}
