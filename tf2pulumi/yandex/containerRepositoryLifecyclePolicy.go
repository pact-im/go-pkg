...
type ContainerRepositoryLifecyclePolicy struct {
	...
	Timeouts ContainerRepositoryLifecyclePolicyTimeoutsOutput `pulumi:"timeouts"`
}
...
type containerRepositoryLifecyclePolicyState struct {
	...
	Timeouts *ContainerRepositoryLifecyclePolicyTimeouts `pulumi:"timeouts"`
}
...
type ContainerRepositoryLifecyclePolicyState struct {
	...
	Timeouts ContainerRepositoryLifecyclePolicyTimeoutsPtrInput
}
...
type ContainerRepositoryLifecyclePolicyArgs struct {
	...
	Timeouts ContainerRepositoryLifecyclePolicyTimeoutsInput
}
...
func (o ContainerRepositoryLifecyclePolicyOutput) Timeouts() ContainerRepositoryLifecyclePolicyTimeoutsOutput {
	return o.ApplyT(func(v *ContainerRepositoryLifecyclePolicy) ContainerRepositoryLifecyclePolicyTimeoutsOutput {
		return v.Timeouts
	}).(ContainerRepositoryLifecyclePolicyTimeoutsOutput)
}
