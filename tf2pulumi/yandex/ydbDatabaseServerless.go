...
type YdbDatabaseServerless struct {
	...
	Timeouts YdbDatabaseServerlessTimeoutsOutput `pulumi:"timeouts"`
...
type ydbDatabaseServerlessState struct {
	...
	Timeouts *YdbDatabaseServerlessTimeouts `pulumi:"timeouts"`
	// Whether TLS is enabled for the Yandex Database serverless cluster.
	// Useful for SDK configuration.
...
type YdbDatabaseServerlessState struct {
	...
	Timeouts YdbDatabaseServerlessTimeoutsPtrInput
	// Whether TLS is enabled for the Yandex Database serverless cluster.
	// Useful for SDK configuration.
...
type YdbDatabaseServerlessArgs struct {
	...
	// Name for the Yandex Database serverless cluster.
	Name     pulumi.StringPtrInput
	Timeouts YdbDatabaseServerlessTimeoutsInput
}
...
func (o YdbDatabaseServerlessOutput) Timeouts() YdbDatabaseServerlessTimeoutsOutput {
	return o.ApplyT(func(v *YdbDatabaseServerless) YdbDatabaseServerlessTimeoutsOutput { return v.Timeouts }).(YdbDatabaseServerlessTimeoutsOutput)
}
